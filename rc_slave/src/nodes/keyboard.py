...
class Playfield:
    ...
    def _animate(self):
        if self.pressed["w"] and self.pressed["a"]: self.p.left()
        elif self.pressed["w"] and self.pressed["d"]: self.p2.right()
        elif self.pressed["w"]: self.p3.forward
        elif self.pressed["s"] and self.pressed["s"]: self.p2.move_up()
